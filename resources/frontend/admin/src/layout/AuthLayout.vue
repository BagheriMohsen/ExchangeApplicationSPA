    ...
    <div class="main-content bg-default">
        ...
        <base-nav class="navbar-top navbar-horizontal navbar-dark"
            ...
            <router-link slot="brand" class="navbar-brand" to="/">
                <img src="img/brand/sample-logo.png"/>
            </router-link>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <router-link class="nav-link nav-link-icon" to="/dashboard">
                            ...
                            <span class="nav-link-inner--text">صفحه ی اصلی</span>
                        </router-link>
                    </li>
                    <!-- <li class="nav-item">
                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            <h3 class="text-white">جهت ثبت نام و احراز هویت در سایت لطفا موارد زیر را کامل نمایید</h3>
